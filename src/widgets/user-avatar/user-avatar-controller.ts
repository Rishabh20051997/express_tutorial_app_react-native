import { firstCharactersOfFirstAndLastName, pickRandomColor } from "@helpers/removeInitialsFromName"
...
const useAvatarController = (props: IUserAvatarProps): IUserAvatarViewProps => {
    ...
    const finalName = removeInitialsFromName(props?.first_name + ' ' + props.last_name)
