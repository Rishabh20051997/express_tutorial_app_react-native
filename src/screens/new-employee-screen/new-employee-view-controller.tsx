...
import { callCreateNewEmployeeApi, getCreatingEmployeeApiStatus, getCreatingEmployeeLoadingStatus } from "@store/splices/employee-entity";
...
const useNewEmployeeScreenViewController = () => {
  ...
  const onSubmit = async () => {
    dispatch(callCreateNewEmployeeApi({
      firstName,
      lastName
    }))
  }
