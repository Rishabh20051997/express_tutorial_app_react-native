...
import { callUpdateEmployeeApi, getUpdatingEmployeeApiStatus, getUpdatingEmployeeLoadingStatus } from "@store/splices/employee-entity";
...
const useEditEmployeeScreenViewController = () => {
  ...
  const onSubmit = async () => {
    dispatch(callUpdateEmployeeApi({
      _id: _id,
      firstName,
      lastName
    }))
