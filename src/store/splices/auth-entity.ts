...
export const getRegistrationLoadingStatus = createSelector(
  (state: RootState) => state.auth,
  (loading: Authentication) => loading.data.registrationProcess.isRegistrationInProcess,
);
...
export const getRegistrationApiSuccessStatus = createSelector(
  (state: RootState) => state.auth,
  (loading: Authentication) => loading.data.registrationProcess.isRegistrationSuccess,
);
