...
const onNewTaskAddDataFetchFailureReducer = (
  ...
  ToastAndroid.show(payload?.message || 'Something went wrong!', ToastAndroid.SHORT)
  taskListState.newTask.isLoading = false;
...
onNewTaskAddSuccessfullyDataFetched: onNewTaskAddSuccessfullyDataFetchedReducer,
